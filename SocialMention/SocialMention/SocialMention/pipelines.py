...
class SocialmentionPipeline(object):
    ...
    def open_spider(self, spider):
        ...
        self.msc = MonitorRedis(self.setr, spider, 'socialmentiondetail:start_urls')
        self.msc.start()

    def close_spider(self, spider):
        self.setr.delete('socialmentiondetail:start_urls')
